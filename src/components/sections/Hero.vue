      ...
      <div class="relative flex w-full flex-col items-center">
        ...
        <div class="lg:column-gap spacing-t grid w-full grid-cols-12">
            ...
            <div class="relative origin-left overflow-hidden sm:scale-150">
              <div id="contact-btn" class="flex -translate-y-full">
                <!-- <Button
                  ...
                  label="Get in touch"
                /> -->
                <Button label="Get in touch" :url="identity.whatsapp" />
              </div>
            </div>
          </div>
          ...
          <div
            ...
            class="relative col-span-4 mt-10 h-[38svh] max-w-lg hidden sm:flex flex-col rounded-lg select-none sm:mt-0 sm:h-full md:h-[50vh]"
          >
            <div class="overlay bg-flax-smoke-50 absolute inset-0 z-2"></div>
            <img
              id="profile-img"
              :src="profile"
              alt="Sooriyaa TN profile"
...
<script setup lang="ts">
  ...
  import { heroText, identity } from '@/data';
