...
<script setup lang="ts">
  ...
  const people = [
    {
      quote:
        'Sooriyaa moves fluidly across AI, engineering, and design — the rare kind of builder who ships an agent in the morning and a motion piece by night. Every project came back sharper than we imagined.',
      author: 'Project Collaborator',
      position: 'Team Lead',
      tags: ['AI', 'Engineering', 'Motion'],
      profile: mohammad,
    },
    {
      quote:
        'Working with Sooriyaa on the ERP build was a standout experience. The system was thoughtful, fast, and genuinely a pleasure to use — technical depth paired with real design sense.',
