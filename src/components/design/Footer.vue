<template>
  <footer
    class="relative flex flex-col items-center justify-center gap-12 p-5 sm:gap-20 sm:p-[2%]"
  >
    ...
    <div class="grid w-full grid-cols-12">
      <div class="col-span-7 place-content-center md:col-span-6">
        <h6 class="heading-4 sm:heading-2 leading-none font-bold">
          © {{ new Date().getFullYear() }} Sooriyaa TN <br />
          All rights reserved.
        </h6>
      </div>
      ...
      >
        <p class="heading-6 font-bold uppercase">Sooriyaa's Local time</p>
